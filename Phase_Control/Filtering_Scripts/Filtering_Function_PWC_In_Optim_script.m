...
function [d_PWC_butter,PB_PWC_out,dim] = Filtering_Function_PWC_In_Optim_script(initial_state,target_state,PWC_PWC,T_PWC_PWC,t_final,spin,PB_PWC)

dim = 2*spin +1;
% inputs needed target_state,t_final,initial_state, spin
