function [Avg_PWC_Fidelity,PWC_Fidelity,PWC_PWC,T_PWC_PWC,PWC_dt,PWC_phase,optimal_PWC_coeff,...
    target_state,t_final,initial_state,psi_f_PWC,Avg_wmax,wmax_PWC]= ...
...
% d_PWC_butter = zeros(NumAvgs,length(spin));
...
for jj = 1:NumAvgs
    ...
    wmax_PWC(jj,ii)= Filtering_Function_PWC_In_Optim_Func(initial_state,...
            target_state,PWC_PWC,T_PWC_PWC,t_final,spin(ii),PB_PWC_0,PB_PWC_f);%think about how to incorporate ,d_PWC_butter(jj,ii)]
end
